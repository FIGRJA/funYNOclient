This project involves porting the YNOproject website to an EasyRPG-based Windows application (including the multiplayer game functionality and all related features).
